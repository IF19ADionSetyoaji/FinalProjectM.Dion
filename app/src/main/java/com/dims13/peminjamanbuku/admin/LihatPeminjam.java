...
import com.dims13.peminjamanbuku.adapter.AdapterPeminjam;
...
public class LihatPeminjam extends AppCompatActivity implements AdapterPeminjam.dataListener {

    private RecyclerView recyclerView;
    private AdapterPeminjam adapter;
        ...
        reference.child("Pinjam")
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        adapter = new AdapterPeminjam(dataBuku, LihatPeminjam.this);
            ...
            reference.child("Pinjam")
                    ...
                    .addOnSuccessListener(new OnSuccessListener() {
                        ...
                        public void onSuccess(Object o) {
                            Toast.makeText(LihatPeminjam.this, "Data Berhasil Dihapus", Toast.LENGTH_SHORT).show();
                        }
                    });
        }
    }
